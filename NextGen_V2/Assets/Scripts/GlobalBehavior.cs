...
public class GlobalBehavior : MonoBehaviour {
    ...
    //enemy text
    int enDest = 0;
    public Text enDestroyed;
    public Text enTouched;
    ...
    void Update()
    {
        if (numofPlanes < maxPlanes)
        {
            CameraSupport s = Camera.main.GetComponent<CameraSupport>();
            GameObject e = Instantiate(plane) as GameObject;
            Vector3 pos;
    ...
    public void EnemyDestroyed()
    {
        enDest++;
        --numofPlanes;
        enDestroyed.GetComponent<Text>();
        enDestroyed.text = "Enemies Destroyed: " + enDest;
    }
